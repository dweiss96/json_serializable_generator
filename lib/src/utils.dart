String toLowerCamelCase(String input) {
  ...
  if(stringParts.isEmpty && start.toUpperCase() == start) return start.toLowerCase().substring(0,1) + start.substring(1).toLowerCase();
  if(stringParts.isEmpty) return start.toLowerCase().substring(0,1) + start.substring(1);
  final modified = [start.toLowerCase().substring(0,1) + start.substring(1).toLowerCase()];
